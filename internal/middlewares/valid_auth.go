...
func ValidAuth(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		if a == "" {
			return echo.NewHTTPError(http.StatusNotFound, utils.ErrorHttp{Message: "Information not found"})
		}
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusNotFound, utils.ErrorHttp{Message: err.Error()})
		}
